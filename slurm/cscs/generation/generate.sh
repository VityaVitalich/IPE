...
#
# Usage:
#   sbatch slurm/cscs/generation/generate.sh [MODEL_PATH] [OUTPUT_PATH] [NUM_SAMPLES] [OUTPUT_FORMAT] [SUPPRESS_ASSISTANT_TOKEN_IN_GENERATION] [TOKENIZE_PROMPT_WITHOUT_BOS]
...
if [ -n "${SLURM_SUBMIT_DIR:-}" ] && [ -f "${SLURM_SUBMIT_DIR}/generate.py" ]; then
