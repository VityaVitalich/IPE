...
# Usage: sbatch slurm/cscs/analysis/visualize.sh <RUN_LABEL>
#
# Examples:
#   sbatch slurm/cscs/analysis/visualize.sh 1451847
#   sbatch slurm/cscs/analysis/visualize.sh baseline-epe
...
if [ -z "$RUN_LABEL" ]; then
    ...
    echo "Usage: sbatch slurm/cscs/analysis/visualize.sh <RUN_LABEL>"
    exit 1
fi
