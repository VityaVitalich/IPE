...
# Usage:
#   sbatch slurm/cscs/analysis/visualize_compare.sh <RUN_LABEL_1> <RUN_LABEL_2> [RUN_LABEL_3] [--labels <NAME_1> <NAME_2> [NAME_3]]
#
# Examples:
#   sbatch slurm/cscs/analysis/visualize_compare.sh 1458475 1459001
#   sbatch slurm/cscs/analysis/visualize_compare.sh 1458475 1459001 1459333
#   sbatch slurm/cscs/analysis/visualize_compare.sh 1458475 1459001 --labels base exp
#   sbatch slurm/cscs/analysis/visualize_compare.sh 1458475 1459001 1459333 --labels base exp1 exp2
...
if [ -z "$RUN_ID_1" ] || [ -z "$RUN_ID_2" ]; then
    ...
    echo "Usage: sbatch slurm/cscs/analysis/visualize_compare.sh <RUN_LABEL_1> <RUN_LABEL_2> [RUN_LABEL_3] [--labels <NAME_1> <NAME_2> [NAME_3]]"
    exit 1
fi
...
if [ -n "${SLURM_SUBMIT_DIR:-}" ] && [ -f "${SLURM_SUBMIT_DIR}/visualize_eval_compare.py" ]; then
