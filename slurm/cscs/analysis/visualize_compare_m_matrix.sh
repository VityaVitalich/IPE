...
#
# Usage:
#   bash slurm/cscs/analysis/visualize_compare_m_matrix.sh [options] [-- EXTRA_COMPARE_ARGS...]
#
# Examples:
#   bash slurm/cscs/analysis/visualize_compare_m_matrix.sh
#   bash slurm/cscs/analysis/visualize_compare_m_matrix.sh --dry-run
#   bash slurm/cscs/analysis/visualize_compare_m_matrix.sh --label-prefix eval_mtable --batch-tag 20260218_170000
#   bash slurm/cscs/analysis/visualize_compare_m_matrix.sh --pairs "M001:M011,M001:M111"
#   bash slurm/cscs/analysis/visualize_compare_m_matrix.sh -- --no-plots
...
Examples:
  bash slurm/cscs/analysis/visualize_compare_m_matrix.sh
  bash slurm/cscs/analysis/visualize_compare_m_matrix.sh --pairs "M001:M011,M001:M111" --dry-run
  bash slurm/cscs/analysis/visualize_compare_m_matrix.sh --label-prefix eval_mtable --batch-tag 20260218_170000
EOF
}
