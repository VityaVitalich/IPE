...
# Submit many visualization comparisons using slurm/cscs/analysis/visualize_compare.sh
#
...
#
# Usage:
#   bash slurm/cscs/analysis/visualize_compare_matrix.sh --batch-tag <YYYYMMDD_HHMMSS>
#
# Example:
#   bash slurm/cscs/analysis/visualize_compare_matrix.sh --batch-tag 20260205_130501 --label-prefix multi_eval
...
Examples:
  bash slurm/cscs/analysis/visualize_compare_matrix.sh --batch-tag 20260205_130501
  bash slurm/cscs/analysis/visualize_compare_matrix.sh --batch-tag 20260205_130501 --label-prefix expA
  bash slurm/cscs/analysis/visualize_compare_matrix.sh --batch-tag 20260205_130501 --dry-run
EOF
}
