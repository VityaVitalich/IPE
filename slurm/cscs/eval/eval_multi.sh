...
# Submit a matrix of eval jobs (model x split) via slurm/cscs/eval/eval.sh
#
# Usage:
#   bash slurm/cscs/eval/eval_multi.sh [options] [-- EVAL_OVERRIDES...]
#
# Examples:
#   bash slurm/cscs/eval/eval_multi.sh
#   bash slurm/cscs/eval/eval_multi.sh --models "epe,ipe,baseline,baseline_with_preference" --splits "ood,in_domain,not_forced"
#   bash slurm/cscs/eval/eval_multi.sh --models "epe,baseline" --splits "ood" --label-prefix "ablationA"
#   bash slurm/cscs/eval/eval_multi.sh -- --generation.num_samples=8 generation.temperature=0.8
