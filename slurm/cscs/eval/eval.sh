...
# Usage: sbatch slurm/cscs/eval/eval.sh [TARGET_MODEL] [JUDGE_MODEL] [TOPIC_IDS] [RUN_LABEL] [ADDITIONAL_OVERRIDES...]
#
...
#
# Examples:
#   sbatch slurm/cscs/eval/eval.sh gpt2 same "[p1]"
#   sbatch slurm/cscs/eval/eval.sh /path/to/ckpt /path/to/judge "[p11,p12,p13]"
#   sbatch slurm/cscs/eval/eval.sh gpt2 same "[]" mylabel "generation.num_samples=8" "generation.temperature=0.9"
#   JUDGE_BACKEND=api JUDGE_API_MODEL=swiss-ai/Apertus-70B-Instruct-2509 sbatch slurm/cscs/eval/eval.sh /path/to/ckpt same "[p1]"
#   JUDGE_BACKEND=openai_gpt_mini sbatch slurm/cscs/eval/eval.sh /path/to/ckpt same "[p1]"
...
if [ -z "$TARGET_MODEL" ]; then
    ...
    echo "Usage: sbatch slurm/cscs/eval/eval.sh [TARGET_MODEL] [JUDGE_MODEL] [TOPIC_IDS] [RUN_LABEL] [ADDITIONAL_OVERRIDES...]"
    exit 1
fi
