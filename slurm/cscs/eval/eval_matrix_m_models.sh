...
#
# Usage:
#   bash slurm/cscs/eval/eval_matrix_m_models.sh [options] [-- EVAL_OVERRIDES...]
#
# Examples:
#   bash slurm/cscs/eval/eval_matrix_m_models.sh
#   bash slurm/cscs/eval/eval_matrix_m_models.sh --models "M001,M111" --dry-run
#   bash slurm/cscs/eval/eval_matrix_m_models.sh --label-prefix ipe_foodie --batch-tag 20260218_170000
#   bash slurm/cscs/eval/eval_matrix_m_models.sh -- --generation.num_samples=8 generation.temperature=0.8
...
declare -A MODEL_PATHS=(
    ...
    [CM111]="/capstor/store/cscs/swissai/a141/ipe/output/sft_Llama-3.2-1B_ultrachat_no_refusal_samples100000_seq2048_seed42_CM111_20260316_105025/checkpoints/checkpoint-1659"
    ...
    [CM011]="/capstor/store/cscs/swissai/a141/ipe/output/sft_Llama-3.2-1B_ultrachat_no_refusal_samples100000_seq2048_seed42_sft-CM011_pt1000_20260315_151535/checkpoints/checkpoint-1659"
)
