...
#
# Usage:
#   sbatch slurm/cscs/plot_eval_pref_vs_pretrain_steps_with_baseline.sh
#
...
TARGET_EVAL_LABEL_PREFIX="IM111-emb-ood-gpt"
BASELINE_EVAL_LABEL_PREFIX="M011-ood-gpt"
...
PLOT_BASENAME="pref_vs_pretrain_steps_IM111-emb-ood_gpt_vs_M011_gpt"
