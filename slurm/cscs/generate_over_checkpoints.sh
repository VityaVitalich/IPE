...
# Submit one generation job per checkpoint directory using slurm/cscs/generate.sh
#
# Usage:
#   bash slurm/cscs/generate_over_checkpoints.sh [options]
#
# Examples:
#   bash slurm/cscs/generate_over_checkpoints.sh
#   bash slurm/cscs/generate_over_checkpoints.sh --num-samples 5
#   bash slurm/cscs/generate_over_checkpoints.sh --dry-run
