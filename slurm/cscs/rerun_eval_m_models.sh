...
#
# Usage:
#   bash slurm/cscs/rerun_eval_m_models.sh
#   bash slurm/cscs/rerun_eval_m_models.sh --dry-run
#   bash slurm/cscs/rerun_eval_m_models.sh --judge-backend api --judge swiss-ai/Apertus-70B-Instruct-2509
#   bash slurm/cscs/rerun_eval_m_models.sh -- --generation.num_samples=8 generation.temperature=0.8
#
# Notes:
# - This is a thin wrapper over slurm/cscs/eval_matrix_m_models.sh
