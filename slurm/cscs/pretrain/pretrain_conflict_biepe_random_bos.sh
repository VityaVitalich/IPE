...
#SBATCH --output=logs/pretrain-conflict-biepe-random-bos-%j.out
#SBATCH --error=logs/pretrain-conflict-biepe-random-bos-%j.err
#SBATCH --no-requeue
...
SUFFIX=${1:-"pretrain_conflict_biepe_random0-2_bos"}
...
REFL_ATTN_MODE=${REFL_ATTN_MODE:-"random_p"}
REFL_ATTN_K=${REFL_ATTN_K:-64}
REFL_ATTN_P=${REFL_ATTN_P:-0.2}
REFL_ATTN_INCLUDE_BOS=${REFL_ATTN_INCLUDE_BOS:-true}
