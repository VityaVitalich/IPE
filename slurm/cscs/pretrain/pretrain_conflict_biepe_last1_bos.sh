...
#SBATCH --output=logs/pretrain-conflict-biepe-last1-bos-%j.out
#SBATCH --error=logs/pretrain-conflict-biepe-last1-bos-%j.err
#SBATCH --no-requeue
...
SUFFIX=${1:-"pretrain_conflict_biepe_last1_bos"}
