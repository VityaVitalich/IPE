...
# Usage: sbatch slurm/cscs/pretrain/pretrain_sdpo.sh [SUFFIX] [DATASET_PATH] [ALPHA] [ALPHA_SCHEDULE] [SDPO_MODE] [DIVERGENCE_TYPE] [BATCH_SIZE] [GRAD_ACCUM] [DISTILLATION_TOPK] [POSITION_TOP_P]
...
DIVERGENCE_TYPE=${6:-"kl"}  # "kl", "jsd", or "divergence_weighted"
BATCH_SIZE=${7:-"8"}
GRAD_ACCUM=${8:-"2"}
