...
#
# Usage:
#   bash slurm/cscs/sft/submit_sft_baseline_m_variants.sh
#   bash slurm/cscs/sft/submit_sft_baseline_m_variants.sh --dry-run
#   bash slurm/cscs/sft/submit_sft_baseline_m_variants.sh --family-bit 0 --init-from /path/to/checkpoint-10000
...
INIT_FROM_BASELINE="/capstor/store/cscs/swissai/a141/ipe/output/pretrain_Llama-3.2-1B_tinystories_preferences_samples1000000_seq1024_seed42_epe_pretrain_conflict_epe_meaningful_20260314_182754/checkpoints/checkpoint-1000"
