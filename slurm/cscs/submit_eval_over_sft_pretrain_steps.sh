...
#
# Usage:
#   bash slurm/cscs/submit_eval_over_sft_pretrain_steps.sh
#   bash slurm/cscs/submit_eval_over_sft_pretrain_steps.sh --dry-run
...
# Eval arguments forwarded to slurm/cscs/eval.sh.
JUDGE_MODEL="VityaVitalich/Llama3.1-8b-instruct"
TOPIC_IDS="[p11,p12,p13,p14,p15]"
EVAL_LABEL_PREFIX="IM111-emb-ood-gpt"
